...
bool CTBot::sendCommand(const char *command, const JsonDocument &jsonData)
{
#endif
	bool response;
...
bool CTBot::sendImageEx(int64_t id, const File &fhandle, uint32_t dataSize)
{
...
bool CTBot::sendImage(int64_t id, const File &fhandle, uint32_t dataSize)
{
...
bool CTBot::sendRawDataEx(int64_t id, const File &fhandle, uint32_t dataSize, const char *filename)
{
...
bool CTBot::sendRawData(int64_t id, const File &fhandle, uint32_t dataSize, const char *filename)
{
	return sendBinaryData(id, CTBotDataTypeRAW, fhandle, dataSize, filename);
}

bool CTBot::sendBinaryDataEx(int64_t id, CTBotDataType dataType, uint8_t *data, const File &fhandle, uint32_t dataSize, const char *filename)
{
	bool response;
...
bool CTBot::sendBinaryDataEx(int64_t id, CTBotDataType dataType, const File &fhandle, uint32_t dataSize, const char *filename)
{
	return sendBinaryDataEx(id, dataType, NULL, fhandle, dataSize, filename);
}

bool CTBot::sendBinaryData(int64_t id, CTBotDataType dataType, uint8_t *data, const File &fhandle, uint32_t dataSize, const char *filename)
{
	CTBotMessageType result = CTBotMessageNoData;
	TBMessage msg;
	uint8_t i = 0;
...
bool CTBot::sendBinaryData(int64_t id, CTBotDataType dataType, const File &fhandle, uint32_t dataSize, const char *filename)
{
